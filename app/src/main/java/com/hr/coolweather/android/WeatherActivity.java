...
public class WeatherActivity extends Activity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=4feadf334d194580a44db5dea2a90dca";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String carWash = getResources().getString(R.string.carWash) + weather.suggestion.carWash.info;
